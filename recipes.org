...
As we can see, in this case both algorithms give good results. The
Savitzky-Golay filter represents more of the variation of the actual
change in the data, whereas the polynomial fit is just a smooth
