...
[[../media/issues/kcachegrind_weirdSlowFast.png]]
...
[[../media/issues/read_csv_ref_types.png]]
...
bit.
[[../media/issues/both_case_callstack.png]]
...
[[../media/issues/non_ref_types_incl_strip.png]]
**** Ref types, slowdown due to =nsuStrip=
[[../media/issues/ref_types_incl_strip.png]]
...
about 3.2 Mio. cycles of =unsureAsgnRef=. In the fast case in the
second figure shows exactly the same number of =unsureAsgnRef= cycles
, but only about 3 Mio. =interiorAllocatedPtr= cycles. 

[[../media/issues/callgrind_cycles_slow.png]]

[[../media/issues/callgrind_cycles_fast.png]]
