...
proc annotateText(): string =
  # pure math in raw string due to too many invalid nim constructs for `latex` macro (would
  # result in ugly mix of strings and identifiers)
  ...
  # squished. Cannot use `equation` or similar :/)
...
ggplot(df, aes("x", "y")) +
  ...
  ggtitle(r"Approximation of Landau distribution: " &
    ...
    titleFont = font(12.0)) +
  ggsave("media/recipes/rTikZLandau.tex", standalone = true)
  # use:
